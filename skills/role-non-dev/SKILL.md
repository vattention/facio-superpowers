...
✓ prepare-context loaded $K docs-only files for non-dev role lens
  Next:
  - "做 spec" / new product or design proposal → host repo's spec workflow
